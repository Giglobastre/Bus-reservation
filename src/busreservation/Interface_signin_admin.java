 ...
 */
public class Interface_signin_admin extends JFrame{
...
private class submittButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                PreparedStatement stmt = conn.prepareStatement("INSERT INTO customer(nom, prenom, login, password, admin) VALUES(?,?,?,?,true)");
