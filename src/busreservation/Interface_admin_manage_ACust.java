 ...
 */
public class Interface_admin_manage_ACust extends JFrame{
    ...
    public Interface_admin_manage_ACust(String in_id){
        
        id=in_id;
        this.setSize(window_Width, window_Height);

        //set a title to the window 
        this.setTitle("Selected customer reservations"); //TJRS THIS
    ...
    private JPanel buildPanel_interface_CviewRes()
    {
        ...
        //SQL
            ...
            try {
                ...
                while(rs.next())
                {
                    CB_affbus.addItem(rs.getString(1)+" : Reservation ID "+" Bus :  "+rs.getString(2)+" Customer : "+rs.getString(3)+" Seat : "+rs.getString(4));
                }
